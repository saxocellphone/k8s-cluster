...
| `cloudflare_dns_record` | `audiobooks`, `c2c`, `openclaw`, `paste`, `qbit`, `radarr`, `rancher`, `sonarr`, `ssh` (orange-clouded CNAMEs → tunnel) |
| `cloudflare_zero_trust_access_application` | `openclaw`, `homelab`, `ssh_bastion` |
